...
const Nav_2 = () => {
    ...
    return (
        <div className='mt-5 flex pl-20 pr-20'>
            ...
            <div className="section-2 ml-auto flex justify-end section-2">
                ...
                <div className="relative flex gap-3 section-2">
                    ...
                    <div className={`absolute left-1/2 top-10 ${(flags) ? 'block' : 'hidden'} allFlags min-h-[60px] min-w-[50px] border-1 border-black`}>
